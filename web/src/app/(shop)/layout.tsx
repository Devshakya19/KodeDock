          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
            <div className="md:col-span-1">
              ...
              <p className="text-[13px] font-medium text-muted-foreground leading-relaxed mb-6 max-w-xs">
                India's premium marketplace for developers. Buy and sell production-grade code
                assets with instant GitHub delivery.
              </p>
            ...
            <div className="flex flex-col gap-3">
              <span className="text-[13px] font-bold text-foreground uppercase tracking-wider mb-2">
                Marketplace
              </span>
              <a
                href="/browse"
                className="text-[14px] font-medium text-muted-foreground hover:text-foreground transition-colors w-fit"
              >
                All Products
              </a>
              <a
