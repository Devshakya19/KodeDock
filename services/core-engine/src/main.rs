...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .route("/api/public/categories", web::get().to(handlers::hq::get_public_categories_handler))
            ...
            .route("/api/hq/finance/payouts", web::get().to(handlers::hq::get_payout_requests))
            .route("/api/hq/finance/payouts/{id}/process", web::put().to(handlers::hq::process_payout))
            ...
            .route("/api/hq/platform/settings", web::get().to(handlers::hq::get_settings))
            .route("/api/hq/audit-logs", web::get().to(handlers::hq::get_audit_logs))
            .route("/api/hq/staff", web::get().to(handlers::hq::get_staff))
            .route("/api/hq/staff", web::post().to(handlers::hq::invite_staff))
            .route("/api/hq/catalog/categories", web::get().to(handlers::hq::get_categories))
            .route("/api/hq/catalog/categories", web::post().to(handlers::hq::create_category))
            .route("/api/hq/catalog/categories/{id}", web::delete().to(handlers::hq::delete_category_handler))
            .route("/api/hq/platform/settings/{key}", web::put().to(handlers::hq::update_setting))
            .route("/api/hq/platform/integrations", web::get().to(handlers::hq::get_integrations))
            .route("/api/hq/platform/integrations/{provider}", web::put().to(handlers::hq::update_integration))
